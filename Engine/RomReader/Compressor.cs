...
namespace Engine.RomReader
{
    public class Compressor
    {
        ...
        */
        public static List<byte> compress(List<byte> input, int initBuffer = 0x07DE, int bufferSize = 0x0800)
        {
        ...
        * @param br: The BinaryReader pointing to the FFV file.
        ...
        */
        public static List<byte> uncompress(long address, BinaryReader br, int headerOffset, bool unheaded = false, bool silent = false)
        {
            long size = 0;
        ...
        * @return: The uncompressed data.
        */
        public static List<byte> uncompress(long address, BinaryReader br, int headerOffset, out long size, bool unheaded = false, bool silent = false)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new Exception("Error reading the file: " + e.ToString());
            }
        ...
        *
        * @param br: The BinaryReader pointing to the compressed data in the FFV file.
        * 
        * @return: The uncompressed data.
        */
        public static List<byte> uncompressType00(BinaryReader br)
        {
            List<byte> output = new List<byte>();
        ...
        * @return: The uncompressed data.
        */
        public static List<byte> uncompressType01(BinaryReader br)
        {
            List<byte> output = new List<byte>();
        ...
        * @return: The uncompressed data.
        */
        public static List<byte> uncompressType02(BinaryReader br, out long size, bool headed = false, bool silent = false)
        {
            List<byte> output = new List<byte>();
        ...
        * @return: The uncompressed data.
        */
        public static List<byte> uncompressTypeWorldMap(BinaryReader br)
        {
            List<byte> output = new List<byte>();
